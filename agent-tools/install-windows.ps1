...
Write-Host "DashClaw Agent Tools Installer (Windows)" -ForegroundColor Cyan

if ([string]::IsNullOrWhiteSpace($WorkspacePath)) {
  $default = Join-Path $HOME "dashclaw"
  $input = Read-Host "Enter your DashClaw workspace path (default: $default)"
