...
def main():
    ...
    parser.add_argument('--push', action='store_true', help='Push to DashClaw API')
        ...
        if getattr(args, 'push', False):
            try:
                ...
                body = {
                    ...
                    'key_decisions': json.dumps(context.get('decisions', [])),
                    'open_tasks': json.dumps(context.get('threads', [])),
                }
                ok, result = push_to_api('/api/handoffs', body)
                if ok:
