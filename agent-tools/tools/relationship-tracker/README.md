...
DashClaw's mini-CRM for tracking contacts and follow-ups across platforms.
...
# Add a contact
python tracker.py add "Name" --platform twitter --handle "@user" -t hot -o "bounty_collab" -n "Notes here"

# List all contacts
python tracker.py list
python tracker.py list --hot          # Hot leads only
python tracker.py list --platform twitter
...
After any Twitter engagement, log it:
```bash
