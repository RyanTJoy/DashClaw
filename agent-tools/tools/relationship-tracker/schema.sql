...
-- DashClaw's mini-CRM for tracking contacts and follow-ups

CREATE TABLE IF NOT EXISTS contacts (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    name TEXT NOT NULL,
    platform TEXT NOT NULL,  -- twitter, linkedin, email, etc.
    handle TEXT,             -- @username or email
    platform_id TEXT,        -- platform-specific ID (twitter user_id, etc.)
