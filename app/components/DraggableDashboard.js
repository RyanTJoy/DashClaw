...
const PRESET_LAYOUTS = {
  'Operations Focus': {
    lg: [
      ...
      { i: 'risk-signals',      x: 0, y: 2,  w: 2, h: 3, ...SHARED_CONSTRAINTS },
      { i: 'recent-actions',    x: 2, y: 2,  w: 2, h: 3, ...SHARED_CONSTRAINTS },
      { i: 'follow-ups',        x: 0, y: 5,  w: 2, h: 2, ...SHARED_CONSTRAINTS },
      { i: 'open-loops',        x: 2, y: 5,  w: 2, h: 2, ...SHARED_CONSTRAINTS },
      // Timeline + quality row
      { i: 'activity-timeline', x: 0, y: 7,  w: 2, h: 4, ...SHARED_CONSTRAINTS, minW: 2 },
      { i: 'drift',             x: 2, y: 7,  w: 1, h: 2, ...SHARED_CONSTRAINTS },
      { i: 'eval-scores',       x: 3, y: 7,  w: 1, h: 2, ...SHARED_CONSTRAINTS },
      { i: 'feedback',          x: 2, y: 9,  w: 1, h: 2, ...SHARED_CONSTRAINTS },
      { i: 'scoring',           x: 3, y: 9,  w: 1, h: 2, ...SHARED_CONSTRAINTS },
      // Intelligence
      { i: 'velocity',          x: 0, y: 11, w: 1, h: 2, ...SHARED_CONSTRAINTS },
      { i: 'learning',          x: 1, y: 11, w: 1, h: 2, ...SHARED_CONSTRAINTS },
      { i: 'prompt-stats',      x: 2, y: 11, w: 2, h: 2, ...SHARED_CONSTRAINTS },
      // Projects + goals
      { i: 'projects',          x: 0, y: 13, w: 2, h: 3, ...SHARED_CONSTRAINTS },
      { i: 'goals',             x: 2, y: 13, w: 2, h: 3, ...SHARED_CONSTRAINTS },
      // Supporting
      { i: 'recent-messages',   x: 0, y: 16, w: 2, h: 2, ...SHARED_CONSTRAINTS },
      { i: 'calendar',          x: 2, y: 16, w: 1, h: 3, ...SHARED_CONSTRAINTS },
      { i: 'context',           x: 3, y: 16, w: 1, h: 2, ...SHARED_CONSTRAINTS },
      { i: 'token-budget',      x: 0, y: 18, w: 1, h: 2, ...SHARED_CONSTRAINTS },
      { i: 'memory-health',     x: 1, y: 18, w: 1, h: 2, ...SHARED_CONSTRAINTS },
      { i: 'token-chart',       x: 2, y: 19, w: 2, h: 2, ...SHARED_CONSTRAINTS, minW: 2 },
  ...
  'Analytics Focus': {
    lg: [
      ...
      { i: 'risk-signals',      x: 0, y: 12, w: 2, h: 2, ...SHARED_CONSTRAINTS },
      { i: 'recent-actions',    x: 2, y: 11, w: 2, h: 3, ...SHARED_CONSTRAINTS },
      { i: 'open-loops',        x: 0, y: 14, w: 1, h: 2, ...SHARED_CONSTRAINTS },
      { i: 'follow-ups',        x: 1, y: 14, w: 1, h: 2, ...SHARED_CONSTRAINTS },
      // Supporting
      ...
      { i: 'calendar',          x: 2, y: 16, w: 1, h: 3, ...SHARED_CONSTRAINTS },
      { i: 'context',           x: 3, y: 16, w: 1, h: 2, ...SHARED_CONSTRAINTS },
      { i: 'integrations',      x: 0, y: 18, w: 1, h: 2, ...SHARED_CONSTRAINTS },
      { i: 'inspiration',       x: 1, y: 18, w: 1, h: 2, ...SHARED_CONSTRAINTS },
    ],
  },
  'Compact Overview': {
    lg: [
      ...
      { i: 'fleet-presence',    x: 0, y: 0,  w: 4, h: 2, ...SHARED_CONSTRAINTS },
      // 4-wide compact row
      { i: 'risk-signals',      x: 0, y: 2,  w: 1, h: 2, ...SHARED_CONSTRAINTS },
      { i: 'open-loops',        x: 1, y: 2,  w: 1, h: 2, ...SHARED_CONSTRAINTS },
      { i: 'recent-actions',    x: 2, y: 2,  w: 1, h: 2, ...SHARED_CONSTRAINTS },
      { i: 'follow-ups',        x: 3, y: 2,  w: 1, h: 2, ...SHARED_CONSTRAINTS },
      // Quality compact row
